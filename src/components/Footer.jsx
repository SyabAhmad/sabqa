        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <Link to="/" className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 bg-[#E85A4F] rounded-xl flex items-center justify-center text-2xl font-bold text-white">
                س
              </div>
              <div>
                <span className="text-2xl font-bold">Sabqa</span>
                <span className="text-sm text-[#E85A4F] block -mt-1">سبقة</span>
              </div>
            </Link>
            <p className="text-gray-400 max-w-md mb-6">
              Your go-to spot for tasty shawarma, burgers, wraps, and refreshing drinks in Riyadh. 
              Quality food at budget-friendly prices.
            </p>
            <div className="flex gap-4">
              <a
                href={`https://wa.me/966567622152`}
                target="_blank"
              ...
              <a
                ...
                className="w-10 h-10 bg-[#E85A4F] rounded-lg flex items-center justify-center hover:bg-[#d44a3f] transition-colors"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            <h3 className="text-lg font-bold mb-4 text-[#E85A4F]">Quick Links</h3>
          ...
          <div>
            <h3 className="text-lg font-bold mb-4 text-[#E85A4F]">Contact</h3>
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-start gap-2">
                ...
                <span>Al Imam Ali Ibn Abi Taleb St,<br/>Al Malaz, Riyadh 12832</span>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span>+966 56 762 2152</span>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span>Open Daily: 12PM - 2AM</span>
              </li>
            </ul>
          </div>
        </div>
